    ...
    return (
      ...
      >
        <article className="article">
          ...
          <h2 className="article__tittle-menu"><strong>Basic Color System</strong></h2>
          ...
          <h2 className="article__tittle-menu"><strong>Primary Color System</strong></h2>
          <div className="article__content">
            <p>
          ...
          <h2 className="article__tittle-menu"><strong>Secondary Color System</strong></h2>
          <div className="article__content">
            <p>
          ...
          <h2 className="article__tittle-menu"><strong>Error Color System</strong></h2>
          <div className="article__content">
            <Row>
              <Col span="2">
          ...
          <h2 className="article__tittle-menu"><strong>Elevation System</strong></h2>
          <div className="article__content">
            <p>
              Elevation atau shadow yang digunakan dibeberapa case seperti di card, button dsb
            </p>
            <p><strong>Usage</strong></p>
            <p>
              Memiliki ketentuan:  #000000 alpha 20<br/>
            ...
            <ul className="evaluation">
              ...
              <li>
                <span className="evaluation__item evaluation__item--20">Elevation 20</span>
              </li>
            </ul>
          </div>
