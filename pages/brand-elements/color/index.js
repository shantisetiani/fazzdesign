    ...
    return (
      ...
      >
        <article className="article">
          ...
          <h2 className="article__title-menu"><strong>Accent Color</strong></h2>
          <div className="article__content">
            <p>
          ...
          <h2 className="article__title-menu"><strong>Warning Color</strong></h2>
          <div className="article__content">
            <Row>
              <Col>
          ...
          <div className="article__content">
            <p>
              ...
              x :  0 |  y : (elevation) |  blur : 4  | spread : 0
            </p>
