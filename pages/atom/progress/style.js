      ...
      <div style={{ marginTop: '40px' }}>
        ...
        <div style={{ marginLeft: '40px' }}>
          ...
          <div style={{ marginLeft: '20px' }}>
            <img src="/static/images/anatomy-progress-stepper.png" />
          </div>
          ...
          <div style={{ marginLeft: '20px' }}>
            ...
            <img src="/static/images/scale-progress-stepper.png" />
          </div>
        </div>
        ...
        <div style={{ marginLeft: '40px' }}>
          ...
          <div style={{ marginLeft: '20px' }}>
            ...
            <img src="/static/images/anatomy-progress-bar.png" />
          </div>
          <h3 className="fw-500" style={{ marginBottom: '20px' }}>b. Scale</h3>
          <div style={{ marginLeft: '20px' }}>
            <img src="/static/images/scale-progress-bar.png" />
          </div>
        </div>
      </div>
    )
